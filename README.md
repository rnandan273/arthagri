...
* [`src/clj/arthagri/`](src/clj/arthagri/): CSS compilation source files (Clojure,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs/arthagri/`](src/cljs/arthagri/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/arthagri/core.cljs): contains the SPA entry point, `init`
* [`test/cljs/arthagri/`](test/cljs/arthagri/): test files (ClojureScript,
...
(headless test environment)
    * For Chromium, set the `CHROME_BIN` environment variable in your shell to the command that
    launches Chromium. For example, in Ubuntu, add the following line to your `.bashrc`:
       ...
       ```
7. Clone this repo and open a terminal in the `arthagri` project root directory
...
in the [`src/clj/arthagri/`](src/clj/arthagri/) directory. CSS files are compiled
...
The `debug?` variable in [`config.cljs`](src/cljs/arthagri/config.cljs) defaults to `true` in
...
```clj
(ns arthagri.example
  (:require [arthagri.config :as config])
